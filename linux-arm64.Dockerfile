...
RUN curl -fsSL "https://github.com/c0re100/qBittorrent-Enhanced-Edition/releases/download/${FULL_VERSION}/qbittorrent-enhanced-nox_aarch64-linux-musl_static.zip" > "/tmp/qbittorrent-nox.zip" && \
